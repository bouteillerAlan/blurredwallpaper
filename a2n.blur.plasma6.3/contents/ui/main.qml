...
WallpaperItem {
  ...
  // BLUR CODE ----------------------------
  readonly property bool isAnyWindowActive: windowInfoLoader.item ? !windowInfoLoader.item.existsWindowActive : true

  // dynamicMode only exists on ImageBackend since Plasma 6.1, guard for older Plasma
  readonly property bool dynamicModeSupported: typeof imageWallpaper.dynamicMode !== "undefined"
  ...
  Binding {
    ...
    value: root.configuration.DynamicMode
